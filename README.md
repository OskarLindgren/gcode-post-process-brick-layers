...
## **Notes**
- Make sure the filemnt your using in Orca slicer has `Don't slow outer walls` enabled under the `cooling` section, this could potentially cause artifacts with brick layers
